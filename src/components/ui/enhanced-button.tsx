  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white shadow-glow hover:shadow-large transform hover:-translate-y-0.5 transition-bounce font-semibold",
        cta: "bg-primary text-primary-foreground shadow-large hover:bg-primary-hover hover:shadow-glow transform hover:-translate-y-1 transition-bounce font-semibold",
        trust: "bg-primary-light text-primary border border-primary/20 hover:bg-primary hover:text-white transition-smooth"
      },
      size: {
